...
$prefix= md5(time()*rand(1, 2)); echo strip_tags(substr($prefix ,0,6));?>" readonly>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="vehicle_model" class="form-control" placeholder="Vehicle Reg. No." >
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
            ...
            <option value=""></option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>penalty</label>
                                                <input type="text" name="penalty" placeholder="fee in naira" class="form-control">
                                            </div>
                                        </div>
                                    </div>
