...
<link rel="stylesheet" href="assets/style.css">
                            ...
                            <div class="content table-responsive table-full-width table-upgrade">
							 <table class="table">
									...
									<tr>
										...
										<tr>
                                        	<td style="background-color:#3dd;">Penalty:</td>
		...
		<Input type="button" value="Generate ticket" class="btn btn-primary" id="myBtn">
        <div id="myModal" class="modal">
			<div class="modal-content">
                <span class="close">&times;
                </span>
				<label>Ticket ID</label>
                 <?php $prefix= md5(time()*rand(1, 2)); echo strip_tags(substr($prefix ,0,6));?>
				 <table class="table">
				 <div class="row">
					<div class="col-md-8 col-md-offset-2">
					 			<?php
...
<div class="content table-responsive table-full-width table-upgrade">
							 <table class="table">
								   ...
								   <tr>
									   ...
									   <button class="btn btn-primary">print reciept</button>
									   </div> <?php }?>
            </div>
</div>
